document.addEventListener('DOMContentLoaded', function() {
    ...
    const formSteps = [
        {
            id: 'step-1',
            title: 'Wie viele Defibrillatoren betreiben Sie?',
            type: 'radio',
            name: 'defibrillator-count',
            options: [
                { value: 'less-than-200', label: 'Weniger als 200' },
                { value: '200-to-900', label: 'Zwischen 200 und 900' },
                { value: 'more-than-900', label: 'Mehr als 900' }
            ]
        },
        {
            id: 'step-2',
            title: 'Perfekt! Und für welches Kundenvolumen?',
            type: 'radio',
            name: 'client-count',
            options: [
                { value: 'less-than-20', label: 'Weniger als 20' },
                { value: '20-to-90', label: 'Zwischen 20 und 90' },
                { value: 'more-than-90', label: 'Mehr als 90' }
            ]
        },
        {
            id: 'step-3',
            title: 'Wählen Sie die Haupthersteller der von Ihnen vertriebenen Modelle.',
            type: 'checkbox',
            name: 'manufacturers',
            options: [
        ...
        {
            id: 'step-4',
            title: 'Ausgezeichnet! Wie viele Techniker werden das Wartungssystem nutzen?',
            type: 'radio',
            name: 'technician-count',
            options: [
                { value: 'single', label: 'Nur einer' },
                { value: '2-to-9', label: 'Zwischen 2 und 9' },
                { value: 'more-than-9', label: 'Mehr als 9' }
            ]
        },
        {
            id: 'step-5',
            title: 'Geben Sie eine E-Mail für das Administrationskonto und die Abrechnung ein.',
            type: 'input',
            inputType: 'email',
            name: 'email',
            placeholder: 'Bsp: ihre@email.com',
            validation: {
                required: true,
                pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/
            }
        ...
        {
            id: 'step-6',
            title: 'Geben Sie den Firmennamen Ihres Unternehmens ein.',
            type: 'input',
            inputType: 'text',
            name: 'company-name',
            placeholder: 'Bsp: IhreUnternehmen',
            validation: {
                required: true,
                minLength: 2
            }
        ...
        {
            id: 'step-7',
            title: 'Schön, Sie kennenzulernen! Stellen Sie kurz Ihr Unternehmen und Ihre Aktivitäten vor (min. 10 Zeichen).',
            type: 'textarea',
            name: 'company-description',
            placeholder: 'Bsp: Vertrieb, Installation und Wartung von Defibrillatoren',
            validation: {
                required: true,
                minLength: 10
            }
            ...
            content: `
                <div class="final-step-content">
                    ...
                    <div class="subscription-summary">
                        <h4 class="selectedplanBIG">Abonnieren Sie den Mosaic-Plan.</h4>
                        <div class="price"><span id="subscription-price">199€</span> <span class="per-month">/Monat (+MwSt.)</span></div>
                    </div>
                    
                    <div class="form-group">
                        <input type="text" id="partner-code" name="partner-code" placeholder="Partnercode (Optional)">
                    </div>
                    ...
                    <div class="form-group terms-checkbox">
                        ...
                        <label for="terms-checkbox">
                            Ich habe die <a class="mimizzzr" href="/conditions">Allgemeinen Geschäftsbedingungen</a> und die <a class="mimizzzr" href="/confidentialite">Datenschutzrichtlinie</a> gelesen und akzeptiere sie.
                        </label>
                    </div>
                </div>
            `
