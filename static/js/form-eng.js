document.addEventListener('DOMContentLoaded', function() {
    ...
    const formSteps = [
        {
            id: 'step-1',
            title: 'How many defibrillators do you operate?',
            type: 'radio',
            name: 'defibrillator-count',
            options: [
                { value: 'less-than-200', label: 'Less than 200' },
                { value: '200-to-900', label: 'Between 200 and 900' },
                { value: 'more-than-900', label: 'More than 900' }
            ]
        },
        {
            id: 'step-2',
            title: 'Perfect! And for what volume of clients?',
            type: 'radio',
            name: 'client-count',
            options: [
                { value: 'less-than-20', label: 'Less than 20' },
                { value: '20-to-90', label: 'Between 20 and 90' },
                { value: 'more-than-90', label: 'More than 90' }
            ]
        },
        {
            id: 'step-3',
            title: 'Select the main manufacturers of the models you distribute.',
            type: 'checkbox',
            name: 'manufacturers',
            options: [
        ...
        {
            id: 'step-4',
            title: 'Great! How many technicians will use the maintenance system?',
            type: 'radio',
            name: 'technician-count',
            options: [
                { value: 'single', label: 'Just one' },
                { value: '2-to-9', label: 'Between 2 and 9' },
                { value: 'more-than-9', label: 'More than 9' }
            ]
        },
        {
            id: 'step-5',
            title: 'Enter an email for the administration account and billing.',
            type: 'input',
            inputType: 'email',
            name: 'email',
        ...
        {
            id: 'step-6',
            title: 'Enter your company\'s business name.',
            type: 'input',
            inputType: 'text',
            name: 'company-name',
            placeholder: 'Ex: YourCompany',
            validation: {
                required: true,
                minLength: 2
            }
        ...
        {
            id: 'step-7',
            title: 'Nice to meet you! Briefly introduce your company and its activities (min 10 characters).',
            type: 'textarea',
            name: 'company-description',
            placeholder: 'Ex: Distribution, installation and maintenance of defibrillators',
            validation: {
                required: true,
                minLength: 10
            }
            ...
            content: `
                <div class="final-step-content">
                    ...
                    <div class="subscription-summary">
                        <h4 class="selectedplanBIG">Subscribe to the Mosaic plan.</h4>
                        <div class="price"><span id="subscription-price">199€</span> <span class="per-month">/month (+VAT)</span></div>
                    </div>
                    
                    <div class="form-group">
                        <input type="text" id="partner-code" name="partner-code" placeholder="Partner Code (Optional)">
                    </div>
                    ...
                    <div class="form-group terms-checkbox">
                        ...
                        <label for="terms-checkbox">
                            I have read and accept the <a class="mimizzzr" href="/conditions">Terms of Service</a> and the <a class="mimizzzr" href="/confidentialite">Privacy Policy</a>.
                        </label>
                    </div>
                </div>
            `
